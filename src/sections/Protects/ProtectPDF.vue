      ...
      <div class="p-8">
        ...
        <div v-if="protectedFile" class="mt-6">
          <div class="flex items-center justify-between bg-green-50 p-4 rounded-lg">
            ...
            <button
              @click="downloadFile"
              class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
            >
              Download
            </button>
          </div>
